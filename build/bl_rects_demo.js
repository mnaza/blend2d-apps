...
function findWasmBinary() {
  return locateFile("bl_rects_demo.wasm");
}
...
(() => {
  // Create a small, never-async wrapper around bl_rects_demo_entry which
  // checks for callers incorrectly using it with `new`.
  var real_bl_rects_demo_entry = bl_rects_demo_entry;
  bl_rects_demo_entry = function(arg) {
    if (new.target) throw new Error("bl_rects_demo_entry() should not be called with `new bl_rects_demo_entry()`");
    return real_bl_rects_demo_entry(arg);
  }
})();
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = bl_rects_demo_entry;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = bl_rects_demo_entry;
} else if (typeof define === 'function' && define['amd'])
  define([], () => bl_rects_demo_entry);
